    ...
    Code: (async function aliasBuildingBlock(context, type, ...args) {
        ...
        if (!context.append.alias) {
            if (!type) {
                return {
                    success: false,
                    reply: `This command can only be used within aliases! Check help using: ${sb.Command.prefix}help abb`
                };
            }
        ...
        if (!type) {
            return {
                success: false,
                reply: `No block type provided! Check help using: ${sb.Command.prefix}help abb`
            };
        }
        ...
        if (!block) {
            return {
                success: false,
                reply: `Incorrect block type provided! Check help using: ${sb.Command.prefix}help abb`
            };
        }
